...
%==== Summary ====%
\vspace*{-6pt}
Founding engineer with 11 years Rust experience (pre-1.0 early adopter), including 5+ years in production systems. Built food assembly robotics control suite from zero to production in 22 months, securing \$10M+ investment from Chipotle and Cava.
\vspace*{8pt}
...
\begin{itemize} \itemsep 1pt
    \item Architected and delivered Hyphen Studio, a Dioxus desktop application for operator makeline configuration
    \item Replaced TypeScript/GraphQL tablet portal with a pure Rust Leptos implementation connecting directly to the IPC broker
    \item Built Rust printer driver and label visualization system for Zebra printers enabling professional branded labels
\end{itemize}

\textbf{Hyphen (Culinary Robotics)} \hfill Remote\\
\textit{Staff Software Engineer (Founding Engineer)} \hfill September 2022 - January 2026\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
...
\begin{itemize} \itemsep 1pt
    ...
    \item \textbf{frost}: dual-backend programming language in Rust with bytecode VM and Cranelift JIT
    \item \textbf{dragonglass}: physically-based 3D rendering engine in Rust and Vulkan (34 stars)
\end{itemize}
