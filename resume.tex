...
\begin{itemize} \itemsep 1pt
    ...
    \item Designed deterministic configuration system enabling fleet scaling from single prototype to \textbf{thousands of machines} across multiple enterprise customers
