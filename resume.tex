...
\textit{Senior Staff Software Engineer (Founding Engineer)} \hfill January 2026 - May 2026\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Architected and shipped Hyphen Studio, a Dioxus desktop application enabling operators to configure makeline layouts and parameters without engineering involvement
    ...
    \item Built Rust printer driver and label visualization system for Zebra printers, enabling immediate branded label output without third-party tooling
\end{itemize}

\textbf{Hyphen (Culinary Robotics)} \hfill Remote\\
\textit{Staff Software Engineer} \hfill September 2022 - January 2026\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    ...
    \item Merged \textbf{1,000+ pull requests} over 4 years as sole architect across firmware, controls, IPC, and cloud infrastructure
